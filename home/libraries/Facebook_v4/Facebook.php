...
class Facebook extends BaseFacebook
{
  ...
  public function __construct($config=null) {
    ...
    if($config == null){
      ...
      //$this->_ci->load->config('johomy_member_config');//移到config/autoload.php
      $config = array(
    ...
    if( !isset($config['appId']) || !isset($config['secret']) ){
      $this->_ci =& get_instance();
      //$this->_ci->load->config('johomy_member_config');//移到config/autoload.php
      $config['appId'] = $this->_ci->config->item('facebook_app_id');
      $config['secret'] = $this->_ci->config->item('facebook_api_secret');
    }
